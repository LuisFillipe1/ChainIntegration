// src/lib.rs
/*
 * Core library for ChainIntegration
 */
...
#[derive(Debug)]
pub struct ChainIntegrationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainIntegrationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainIntegration processing");
    
    let mut processor = ChainIntegrationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainIntegrationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainIntegrationProcessor::new(false);
